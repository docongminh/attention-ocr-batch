...
def train():
    ...
    callbacks = [
        PeriodicCallback(
            ModelSaver(max_to_keep=40, keep_checkpoint_every_n_hours=1),
            every_k_epochs=1),
        # linear warmup
    ...
    # print(len(tf.gfile.Glob(cfg.pretrain_path + "*")))
    ...
    # else:
    #     session_init = SaverRestoreRelaxed(cfg.pretrain_path, ignore=['global_step:0'])
