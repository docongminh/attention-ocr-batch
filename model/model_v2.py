...
def inception_padding_model(images, labels, wemb_size, seq_len, num_classes, lstm_size, is_training=True, 
        dropout_keep_prob=0.7, weight_decay=0.00004, final_endpoint='layer_7', name='MobilenetV3', reuse=None):
    """
    ...
    with tf.compat.v1.variable_scope(name, reuse=reuse) as scope:
        ...
        with slim.arg_scope(mobilenet_v2_arg_scope()):
            with slim.arg_scope([slim.batch_norm, slim.dropout], is_training=is_training):
                net, end_points = mobilenet_v3_large_seg(images, final_endpoint=final_endpoint, scope=scope)  # Mixed_6h Mixed_7d
