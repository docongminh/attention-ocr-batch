    ...
    with tf.compat.v1.variable_scope(scope, 'InceptionV4', [inputs]):
        with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d],
            ...
            net = slim.conv2d(inputs, 32, [3, 3], stride=2,
                              padding='SAME', scope='Conv2d_1a_3x3',trainable=False)
            if add_and_check_final('Conv2d_1a_3x3', net): return net, end_points
            # 149 x 149 x 32
            net = slim.conv2d(net, 32, [3, 3], padding='SAME',
                              scope='Conv2d_2a_3x3',trainable=False)
            if add_and_check_final('Conv2d_2a_3x3', net): return net, end_points
            # 147 x 147 x 32
            net = slim.conv2d(net, 64, [3, 3], scope='Conv2d_2b_3x3',trainable=False)
            ...
            with tf.compat.v1.variable_scope('Mixed_3a'):
                ...
                with tf.compat.v1.variable_scope('Branch_1'):
                    branch_1 = slim.conv2d(net, 96, [3, 3], stride=2, padding='SAME',
                                         scope='Conv2d_0a_3x3',trainable=False)
