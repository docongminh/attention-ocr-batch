...
# from model.nets.mobilenet import conv_blocks
# from model.nets.mobilenet import mobilenet
# from model.nets.mobilenet import mobilenet_v2
# from model.nets.mobilenet import mobilenet_v3
...
_MOBILENET_V3_LARGE_FINAL_ENDPOINT = 'layer_6'
_MOBILENET_V3_SMALL_FINAL_ENDPOINT = 'layer_13'
print(str(conv_blocks))
