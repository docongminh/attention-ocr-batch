...
class AttentionOCR(ModelDesc):
    ...
    """
    def inputs(self):
        return [tf.TensorSpec([None, cfg.image_size, cfg.image_size_width, 3], tf.float32, 'image'),
    ...
    def optimizer(self):
        ...
        lr = tf.get_variable('learning_rate', initializer=cfg.learning_rate, trainable=False)
        ...
        #lr = tf.compat.v1.train.piecewise_constant(global_step, [90000,120000,140000,200000],[cfg.learning_rate,cfg.learning_rate/2,cfg.learning_rate/5,cfg.learning_rate/9,cfg.learning_rate/10])
