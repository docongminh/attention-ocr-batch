...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint_path', type=str, help='path to tensorflow model', default='/home/quannd/Vin-BigData/Attention_OCR_Batch/checkpoint_mobilenet_v3_large_1.0_pristine')
    args = parser.parse_args()

    from dataset import CMT

    CMT = CMT()
    CMT.load_data() 
    print(len(CMT.filenames))

    eval(args, CMT.filenames, CMT.points, CMT.transcripts)